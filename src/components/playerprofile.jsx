  ...
  return (
    <div className="player-profile-container">
      <div className="profile-header">
        <button className="back-button" onClick={() => navigate("/player/viewallplayers")}>
          Back to Players
        </button>
        ...
        {activeTab === "profile" && (
          <div className="profile-details">
            <div className="profile-image-container">
              ...
              <div className={`status-badge ${player.medicalStatus.toLowerCase()}`}>{player.medicalStatus}</div>
            </div>
                ...
                <div className="info-display">
                  ...
                  <div className="info-row">
                    ...
                    <span className="info-value">
                      {formatDate(player.dob)} (Age: {calculateAge(player.dob)})
                    </span>
                  </div>
                  ...
                  <div className="info-row">
                    ...
                    <span className="info-value rating">{player.rating}/100</span>
                  </div>
                </div>
              )}
            </div>
