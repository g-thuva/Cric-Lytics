                ...
                <td>
                  <div className="action-buttons">
                    <button
                      ...
                      onClick={() => navigate(`/scorecard/${match.matchCode}`)}
                    >
                      More
                    </button>
                    <button
...
import { useState, useEffect } from "react";
import { useNavigate } from "react-router-dom";
import { FaSearch } from "react-icons/fa"; //search icon components from react icon library
...
const MatchHistory = () => {
  ...
  const filteredMatches = match.filter((match) => {
    const matchesSearch = match.oppositeTeamName //sorting by name
      .toLowerCase()
      .includes(searchTerm.toLowerCase());
  ...
  const handleScoreCard = (matchCode) => {
              ...
              >
                ...
                <td>
                  <div className="action-buttons">
                    <button
                      className="view-scorecard-btn"
                      onClick={() => handleScoreCard(match.matchCode)}
                    >
                      More
                    </button>
                    <button
