...
<div id="logo">
  ...
  <div id="main-content">
    <div id="left-column">
        ...
        <p  className="content-description" style={{marginLeft: 25 ,marginTop: 15 }}>This is my pitch. Here are my passions: </p>
        <ul style={{marginTop: 0 , padding: 25}}>
          <li><b>Batting style</b></li>
          <li><b>Bowling style</b></li>
      ...
      <div >
		  <div id="nav"> Some Of My Famous Quotes<br></br><b><a href="index.html">Overview</a> | <a href="#">Stats</a> | <a href="#">Matches</a> | <a href="#">News</a> | <a href="#">Photos</a> | <a href="#">Add Player</a> | <a href="#">Add Coach</a> | 
      <a href="/OurTeam">Add Match Data</a> | <a href="#">Add News</a> | <a href="#">Add Moments</a> | <a href="#">Up Comming Math data</a> | <a href="/sponsorship_data">Add sponsoreship Details  </a> | <a href="/Add_socialmedia">Add social meadia Details</a> 
    ...
    <div id="right-column">
      <div id="main-image">
      { <img src={profile} alt="profile" className="main-imgage" width={100} height={50}/> }
