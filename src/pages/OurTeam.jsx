...
const OurPlayers = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to player performance form with the match ID
      navigate(`/our-players/${savedMatch.matchCode}`);
        ...
        <div id="form-container">
          <div id="match-details" className="player-form">
            <form id="matchForm" onSubmit={handleSubmit} className="match-form">
              ...
              <button onClick={handleOurPlayer}>Player Performance</button>
            </form>
          </div>
        </div>
      </main>
